namespace ConnectSphere.API.Domain.ValueObjects
{
    ...
    public sealed record PersonName
    {
        ...
        {
            DomainValidator.ThrowIfStringNullOrEmpty("First name", firstName, new PersonNameNotValidException("First name is required."));
            DomainValidator.ThrowIfExceedsMaxLength("First name", firstName, MaxLength, new PersonNameNotValidException($"First name cannot exceed {MaxLength} characters."));

            DomainValidator.ThrowIfExceedsMaxLength("Middle name", middleName, MaxLength, new PersonNameNotValidException($"Middle name cannot exceed {MaxLength} characters."));

            DomainValidator.ThrowIfStringNullOrEmpty("Last name", lastName, new PersonNameNotValidException("Last name is required."));
            DomainValidator.ThrowIfExceedsMaxLength("Last name", lastName, MaxLength, new PersonNameNotValidException($"Last name cannot exceed {MaxLength} characters."));
